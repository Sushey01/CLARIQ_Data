...
def rebuild_vector_db(clear_existing: bool = True):
    ...
    if clear_existing:
        # Get or create a clean collection (deleting the old one if it exists to prevent pollution)
        try:
            client.delete_collection(name="curriculum")
            print("Deleting old collection to prevent data pollution...")
        except Exception:
            pass
    ...
    try:
        ...
        collection = client.get_collection(name="curriculum")
